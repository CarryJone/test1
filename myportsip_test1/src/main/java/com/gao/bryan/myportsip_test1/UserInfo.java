...
public class UserInfo {
	String mUsername = "";
	String mUserpwd= "";
	String mSipServer= "sip.linphone.org";
	String mUserdomain= "";
	String mAuthName= "";
	String mUserDisName= "";
	String mStunSvr= "";
	...
	int mStunPort= 0;
	int msipPort= 5060;
	int mtransType= PortSipEnumDefine.ENUM_TRANSPORT_TCP;
	...
	public String toString() {
		return "UserInfo{" +
				"mUsername='" + mUsername + '\'' +
				", mUserpwd='" + mUserpwd + '\'' +
				", mSipServer='" + mSipServer + '\'' +
				", mUserdomain='" + mUserdomain + '\'' +
				", mAuthName='" + mAuthName + '\'' +
				", mUserDisName='" + mUserDisName + '\'' +
				", mStunSvr='" + mStunSvr + '\'' +
				", mStunPort=" + mStunPort +
				", msipPort=" + msipPort +
